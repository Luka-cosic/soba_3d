...
const Stolice = ({ paintChair, setShowArrow, clicked, click, setShowLopteS, setShowTableMa, nodes, materials, showLopteS, setPaintChair }) => {
  ...
  return (
    <>
      <group position={[1.225, -2.389, 0.514]} className="chair" onClick={chairStyle} rotation={[0, -1.571, 0]} scale={0.368}>
      ...
      <group position={[-1.301, -2.377, -0.908]} onClick={chairStyle} rotation={[1.571, 1.566, -1.571]} scale={0.368} >
      ...
      <group position={[-1.261, -2.329, 0.581]} onClick={chairStyle} rotation={[1.571, 1.535, -1.571]} scale={0.368}>
